...
public class DecryptionPass extends javax.swing.JFrame
{
   private File[] listOfFilesAndFolders;
    public DecryptionPass(File[] listOfFilesAndFolders)
    {
    ...
    {//GEN-HEADEREND:event_proceedButtonActionPerformed
        ...
        new EandD(listOfFilesAndFolders, "decrypt", new String(passwordField.getPassword())).execute();
