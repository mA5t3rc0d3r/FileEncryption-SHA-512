...
public class FileCheckDuringEncryption extends javax.swing.JDialog
{
    public FileCheckDuringEncryption(java.awt.Frame parent, boolean modal, String filePath)
    {
        super(parent, modal);
        ...
        {
            java.util.logging.Logger.getLogger(FileCheckDuringEncryption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
