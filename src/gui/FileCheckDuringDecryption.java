...
public class FileCheckDuringDecryption extends javax.swing.JDialog
{
    public FileCheckDuringDecryption(java.awt.Frame parent, boolean modal, String filePath)
    {
        super(parent, modal);
        ...
        {
            java.util.logging.Logger.getLogger(FileCheckDuringDecryption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
