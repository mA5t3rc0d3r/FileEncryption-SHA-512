...
public class EandDProgress extends javax.swing.JFrame
{
    ...
    public EandDProgress(String encryptOrDecrypt)
    {
        ...
        {
            java.util.logging.Logger.getLogger(EandDProgress.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
